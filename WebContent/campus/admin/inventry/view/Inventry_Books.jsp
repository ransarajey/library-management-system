            ...
            <section class="main-content">
                ...
                <div class="content-wrap">
				 ...
				 <%
                        ...
                        %>
                       <a href="<%=Common_Things.url %>/complete-details-of-book/?s=<%=book_sl_no %>" class="btn btn-success">Back</a>
                    <div class="row mg-b" >
                     
                    
                        <div class="col-xs-6" > 
                        
                            <h3 class="no-margin"></br>Add Inventry</h3>
                                        ...
                                        <thead>  
                                            ...
                                            <tr>		<form action="<%=Common_Things.url %>/print-bar-code/" target="_blank">
	                                						...
	                                						<td>
	                                							...
	                                							<input type="submit" value="Print All Barcode" class="btn btn-success btn-xs">
	                                						</td>
                                			 ...
                                			 <tr>	<form action="<%=Common_Things.url %>/print-one-bar-code/" target="_blank">
                                						...
                                						<td><input type="text" name="h" value="134"> </td>
                                						<td>Code</td>
                                						<td><input type="text" name="bar" value=""> </td>
                                						<td>
	                                							
	                                							<input type="submit" value="Print Barcode" class="btn btn-success btn-xs">
	                                						</td>
                                					</form> 
                                					</tr>
