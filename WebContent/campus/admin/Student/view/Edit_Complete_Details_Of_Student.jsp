                                                      ...
                                                      <input type="hidden" name="student_id" value="<%=Student_id %>">
                                                        <div class="form-group">
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="Batch" name="batch" value="<%if(obj_Student_Use_Bean.getBatch()!=null){out.println(obj_Student_Use_Bean.getBatch());} %>" >
                                                            </div>
                                                        </div>
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="Course" name="course" value="<%if(obj_Student_Use_Bean.getCourse()!=null){out.println(obj_Student_Use_Bean.getCourse());} %>" >
                                                            </div>
                                                        </div>
                                                       <hr> 
