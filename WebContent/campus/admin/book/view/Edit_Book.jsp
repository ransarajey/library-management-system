            ...
            <section class="main-content">
                ...
                <div class="content-wrap">
                    ...
                    <div class="row mg-b">
                       ...
                       <a href="<%=Common_Things.url %>/complete-details-of-book/?s=<%=book_sl_no %>" class="btn btn-success">Complete Details</a>
                       <a href="<%=Common_Things.url %>/search-book/?kou=<%="232323243kihnadfhlacfhdkaudfhnakcdfchakdfhbkavhdfhna" %>" class="btn btn-success">Search Book</a>
