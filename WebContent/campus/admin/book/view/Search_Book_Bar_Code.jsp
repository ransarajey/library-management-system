            ...
            <section class="main-content">
                ...
                <div class="content-wrap">
                    ...
                    <div class="row mg-b">
                       ...
                       <a href="<%=Common_Things.url %>/admin-add-book/?kou=<%="232323243kihnadfhlacfhdkaudfhnakcdfchakdfhbkavhdfhna" %>" class="btn btn-success">Add Book</a>
                                                     ...
                                                     <hr> 
                                                        ...
                                                        <div class="form-group">   
                                                            <div class="col-sm-offset-2 col-sm-15">
                                                                <button type="submit" class="btn-primary">Search Book</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <form action="<%=Common_Things.url%>/search-bar-code/" class="form-horizontal" role="form">
                                                     ...
                                                     <hr> 
                                                        ...
                                                        <div class="form-group">   
                                                            <div class="col-sm-offset-2 col-sm-15">
                                                                <button type="submit" class="btn-primary">Search Bar Code</button>
                                                            </div>
                                                        </div>
                                                    </form>
