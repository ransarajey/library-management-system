                ...
                <div class="content-wrap">
                    ...
                    <%
							...
							%>
                                ...
                                <div class="panel-heading">Library Availability    &nbsp &nbsp
                                <a href="<%=Common_Things.url %>/inventry-books/?kou=<%=obj_Book_Use_Bean.getBook_sl_no() %>" class="btn btn-warning">View Inventory</a>
