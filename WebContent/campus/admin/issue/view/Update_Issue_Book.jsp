            ...
            <section class="main-content">
                ...
                <div class="content-wrap">
                    ...
                    <div class="row mg-b">
                        ...
                        <a href="<%=Common_Things.url %>/issue-history/?jin=<%=obj_Issue_Use_Bean.getBook_title() %>&bn=<%=obj_Issue_Use_Bean.getBarcode() %>" class="btn btn-success">Back</a>
                                                     ...
                                                     <hr>  
                                                        ...
                                                        <div class="form-group">   
                                                            <div class="col-sm-offset-2 col-sm-15">
                                                                ...
                                                                <input type="button" value="Update Issue" class="btn btn-primary" onClick="confSubmit(this.form);"></input>	
